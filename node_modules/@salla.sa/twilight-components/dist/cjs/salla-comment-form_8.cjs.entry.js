...
const SallaCommentForm = class {
    ...
    render() {
        return (index.h(index.Host, { key: '1c2cdcb7dea3afa14a9fbe7700b05241c6e36770' }, !!this.canComment ? index.h("form", { ref: frm => this.commentForm = frm }, index.h("div", { class: "s-comment-form-wrapper" }, this.showAvatar ?
...
const SallaCommentItem = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '93d39f2ef35c0cfdcd6333e58e6a836845b4fe12', class: isAdmin ? 's-comments-item-admin' : 's-comments-item' }, index.h("div", { key: 'c160b10f946149c293cb0daeaf96aa7b06ba095e', class: { "s-comments-item-wrapper": !isAdmin, "s-comments-item-admin-wrapper": isAdmin }, id: `s-comments-item-${this.comment.id}` }, index.h("div", { key: '60728bde4f0293cf419b589759b6621c5f0a519a', class: "s-comments-item-inner s-comments-flex-1" }, isAdmin && index.h("span", { key: 'aac6a394aa6460756c4c54d0a0c671078d1dddd6', class: "s-comments-item-reply-icon", innerHTML: Reply }), index.h("div", { key: 'cdca36fac4f23720084477ee889325942d25341e', class: "s-comments-item-avatar" }, index.h("img", { key: '07e8e17f7470d87607c8aaa8f15e283b129ca070', "data-src": this.comment?.avatar, alt: this.comment?.name, src: this.comment?.avatar, class: "s-comments-item-avatar-img lazy" })), index.h("div", { key: '6ef14e9b64d8300a24d886c081cc66ec621fd2a6', class: "s-comments-flex-1" }, index.h("div", { key: '4f72cfb690978fae30d8ef7c957e6adf53a2872d', class: "s-comments-item-user-wrapper" }, index.h("div", { key: '413840281c0050521a8ae4fd60e502ed821f4260', class: "s-comments-item-user-info" }, index.h("h3", { key: '814c32cefc6b62585022ab3e1cdb59965553f1d2', class: this.comment.is_pinned ? "s-comments-item-user-info-name" : "s-comments-item-user-info-name-with-margin" }, this.comment?.name), this.comment.is_pinned ?
            ...
            index.h("div", { class: "s-comments-flex" }, this.comment.has_order ?
                [index.h("span", { class: "s-comments-item-has-order-check-icon", innerHTML: check.iconCheck }), index.h("span", { class: "s-comments-item-has-order-check-text" }, this.has_bought_trans, " ", this.comment.rating ? ', ' : '')] : null, !!this.comment.rating ?
                index.h("span", { class: "s-comments-item-rated-widget" }, this.rated_trans) : null)
            : null), index.h("p", { key: '7c6745073e250e100c8a613e4fd94d751042fb7f', class: "s-comments-item-timestamp s-ltr" }, this.getDate(this.comment.created_at?.date), index.h("span", { key: '011cfc88b9702e14f6ea9d8ded0fa6f8678adb18', class: "s-comments-item-time" }, " - ", this.getTime(this.comment.created_at?.date))), !!this.comment.rating || !!this.comment.stars ?
            index.h("salla-rating-stars", { size: "mini", class: "s-comments-item-stars", value: this.comment.rating || this.comment.stars })
            : null), index.h("div", { key: '044599867529f9526306ac258981a15e4c43e369', class: "s-comments-item-content" }, index.h("p", { key: 'd3d082f84a154205bb6eedb0d14c2bb9a83387ee', innerHTML: this.comment.content }), this.allowAttachImages && index.h("div", { key: 'c475b4911834163084ede77e2c1f289ea9efddca', class: "s-comments-item-images" }, this.comment.images.map((image, index$1) => (index.h("img", { key: index$1, src: image, alt: "", onClick: () => this.modal.open() }))), index.h("salla-modal", { key: '384d4555813e8e9c4bf7c6ad626def802f8f6f5a', ref: modal => this.modal = modal, width: "sm" }, index.h("salla-slider", { key: 'a2be6511ff82555b87196183c6f463f4582c18c4', id: `s-comments-item-${this.comment.id}-images`, class: "s-comments-item-images-slider", type: "thumbs", "auto-height": true, showControls: this.comment.images.length > 1 ? true : false, "show-thumbs-controls": "false" }, index.h("div", { key: 'c6029d94bdddf9958758fbd8c3dbca3e40ad1c01', slot: 'items' }, this.comment.images.map((image, index$1) => (index.h("img", { key: index$1, src: image, alt: "" })))), index.h("div", { key: 'b5febbea6d46ce3b920f5bc15866eebb54f440e4', slot: "thumbs" }, this.comment.images.map((image, index$1) => (index.h("div", { class: "s-comments-item-images-slider-thumb" }, index.h("img", { key: index$1, src: image, alt: "" })))))))), this.allowLikes && !isAdmin && salla.url.is_page('product.single') ? index.h("salla-button", { ref: el => this.likeBtn = el, class: `s-comments-item-like-btn ${this.likedComments.includes(this.comment.id) ? 'liked' : ''}`, loaderPosition: 'center', fill: 'outline', size: 'small', onClick: () => this.toggleLike() }, index.h("span", null, this.helpfulLabel, " ", this.likesCount > 0 ? `(${this.likesCount})` : ''), index.h("span", { innerHTML: ThumbsUp })) : '', this.comment.is_pending ?
...
const SallaRatingStars = class {
    ...
    handleRating() {
        ...
        this.starsElem.querySelectorAll('.s-rating-stars-btn-star')
            .forEach((star, index) => Helper.Helper.toggleElementClassIf(star, 's-rating-stars-selected', 's-rating-stars-unselected', () => index < selectedIndex));
    ...
    render() {
        return this.translationsLoaded ? (this.host.closest('.swiper-slide')?.classList.contains('swiper-slide-duplicate')
            ? ''
            : (index.h(index.Host, null, (this.value || this.value == 0) && !this.editable ?
                index.h("div", { class: "s-rating-stars-wrapper" }, this.createStars(this.value), this.withLabel && this.reviewLabel ? index.h("span", { class: "s-rating-stars-label" }, this.reviewLabel) : '')
                :
                    index.h("div", { class: "s-rating-stars-wrapper" }, index.h("div", { class: "s-rating-stars-element", ref: (el) => this.starsElem = el }, index.h("input", { type: "hidden", class: "rating_hidden_input", name: this.name, value: "" }), [1, 2, 3, 4, 5].map(star => index.h("button", { class: `s-rating-stars-btn-star s-rating-stars-` + this.size, "data-star": star }, index.h("span", { innerHTML: star2.Star })))), this.withLabel && this.reviewLabel ? index.h("span", { class: "s-rating-stars-label" }, this.reviewLabel) : '')))) : (index.h(index.Host, null));
    }
    componentDidLoad() {
        this.initiateRating();
...
const SallaReviewCard = class {
    ...
    renderStars() {
        return Array(5)
            .fill(null)
            .map((_, index$1) => index.h("span", { key: index$1, innerHTML: this.review.stars >= index$1 + 1 ? IconStar2 : IconStar2Muted }));
    }
    renderDots() {
        return this.images.map(({ url }, index$1) => (index.h("button", { key: url || index$1, type: "button", class: `s-review-card-slider-dot ${this.currentSlide === index$1 ? "active" : ""}`, onClick: () => this.goToSlide(index$1), "aria-label": `Go to slide ${index$1 + 1}`, onPointerDown: () => this.goToSlide(index$1) })));
    }
    renderSlider() {
        if (!this.hasMultipleImages)
            return null;
        return (index.h("div", { class: "s-review-card-slider-container" }, index.h("div", { class: "s-review-card-slides", style: { transform: this.slideTransform } }, this.images.map((image) => (index.h("div", { key: image?.id, class: "s-review-card-slider-slide" }, index.h("img", { src: image.url, alt: image.alt || "Product image", width: 275, height: 275, loading: "lazy", draggable: false }))))), index.h("div", { class: "s-review-card-slider-dots" }, this.renderDots())));
    }
    renderSingleImage() {
        const image = this.review?.product?.image;
        if (!image || this.hasMultipleImages)
            return null;
        return (index.h("img", { src: image.url, alt: image.alt || "Product image", class: "s-review-card-image", width: 275, height: 275, loading: "lazy", decoding: "async", draggable: false }));
    }
    renderHeader() {
        return (index.h("div", { class: "s-review-card-header" }, index.h("div", { class: "s-review-card-reviewer-name" }, index.h("p", null, this.review?.name), this.review?.has_order && index.h("span", { class: "s-review-card-verified-icon", innerHTML: check.iconCheck })), index.h("div", { class: "s-review-card-stars" }, this.renderStars())));
    }
    renderProductInfo() {
    ...
    render() {
        return index.h("div", { key: '48e1eb2b71e5ee6e66def2aac42e9b6255935a17', class: "s-review-card-container" }, this.renderSlider(), this.renderSingleImage(), renderDivider(), index.h("div", { key: '0b24ea13f1f31224fff7e73d5db6c428adef0bd9', class: "s-review-card-content" }, this.renderHeader(), index.h("p", { key: '44501e61b5eed711820bece91053534a2baacbde', class: "s-review-card-review-content", innerHTML: this.review?.content }), renderDivider(), this.renderProductInfo()));
    }
    get el() { return index.getElement(this); }
};
const renderDivider = (className) => (index.h("div", { class: `s-review-card-divider ${""}` }));
...
const SallaReviewsPage = class {
    ...
    render() {
        return (index.h("host", { key: 'a38a67a03a9ef104b0233f560d764b31e5dbe636' }, index.h("div", { key: '9bcd8e6b51ade66e2a7ec6499c03d481e9ea9462', class: "s-reviews-page-header-wrapper" }, index.h("h2", { key: '2af4f0e2f6814278c5f02a53cf20223eba0924b7', class: "s-reviews-page-title" }, this.langTitlesReviews, index.h("span", { key: '9741437a092ae5b56f2633b0cdd7629bb83bcdf4', class: "s-reviews-page-count" }, "(", this.langRatingReviews, ")")), index.h("div", { key: '68255bc0c46369dfbfa7966cbae3524014a020e0', class: "s-reviews-page-filter-wrapper" }, index.h("label", { key: '5aa4b79c6de3f960d235b35a3391e0aa883f1803', class: "s-reviews-page-filter-label", htmlFor: "testimonials-filter" }, this.langSorting), index.h("select", { key: '66ffbca8eab701b4177fbd16deb6b45cd8b03440', onChange: (e) => this.handleSorting(e), disabled: !this.reviews.length, class: "s-reviews-page-filter" }, this.renderSortingOptions()))), this.reviews.length ? index.h("main", { class: "s-reviews-page-grid", ref: el => {
                this.wrapper = el;
...
const SallaReviewsSummary = class {
    ...
    renderRecommendation() {
        ...
        return (index.h("div", { class: `${classes.base} ${classes.standalone}`.trim() }, index.h("h4", { class: "s-reviews-summary-recommendation-percentage" }, "%", this.data?.recommendation), index.h("p", { class: "s-reviews-summary-count" }, this.recommendedLabel)));
    }
    render() {
        if (!this.canRender)
            return null;
        ...
        const reviewElements = Object.keys(ratings).reverse().map((rating) => {
            ...
            return (index.h("div", { key: rating, class: "s-reviews-summary-row" }, index.h("div", { class: "s-reviews-summary-row-rate" }, rating, " ", index.h("span", { innerHTML: star2.Star })), index.h("salla-progress-bar", { class: "s-reviews-summary-progress", value: percentage, target: 100, hideUnits: true, height: '16px' }), index.h("span", { class: "s-reviews-summary-percentage" }, percentage, "%")));
        });
        return (index.h(index.Host, { class: "s-reviews-summary-wrapper" }, index.h("div", { class: "s-reviews-summary-header" }, index.h("div", { class: "s-reviews-summary-header-section" }, index.h("h3", { class: "s-reviews-summary-average" }, this.data.rating), index.h("div", null, index.h("salla-rating-stars", { size: 'large', value: this.data.rating }), index.h("p", { class: "s-reviews-summary-count" }, this.basedOnLabel, " ", salla.helpers.number(salla.lang.choice('pages.rating.reviews', this.data.count))))), this.renderRecommendation()), index.h("div", { class: "s-reviews-summary-rows" }, reviewElements)));
    }
};
...
exports.salla_review_card = SallaReviewCard;
exports.salla_reviews = SallaReviews;
exports.salla_reviews_page = SallaReviewsPage;
exports.salla_reviews_summary = SallaReviewsSummary;
