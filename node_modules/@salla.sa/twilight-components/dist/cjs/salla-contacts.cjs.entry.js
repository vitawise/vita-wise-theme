...
const SallaContacts = class {
    ...
    render() {
        ...
        if (this.isHeader) {
            return (index.h(index.Host, { class: "s-contacts s-contacts-header" }, contactsArray.filter((contact) => contact.type == 'phone' || contact.type == 'email').map((contact, index$1) => (index.h("a", { href: this.getContactLink(contact.type), key: index$1, class: "s-contacts-topnav-link" }, contact.type === 'email' ? (contact.value) : ([
                index.h("span", null, this.contactsTitle, ": "),
                index.h("a", { class: "unicode", href: this.iconsList[contact.type] }, contact.value)
            ]))))));
        }
        return (index.h(index.Host, { class: "s-contacts" }, !this.hideTitle && index.h("h3", { class: "s-contacts-title" }, this.contactsTitle), index.h("div", { class: {
            ...
            } }, contactsArray.map((contact, index$1) => (index.h("div", { key: index$1, id: "contact-slot", innerHTML: this.contactSlot
...
SallaContacts.style = sallaContactsCss;

exports.salla_contacts = SallaContacts;
