...
const SallaMaintenanceAlert = class {
    ...
    render() {
        return (index.h(index.Host, { key: '01c89bdfb43cf8167a80c3b534db99c2b065b470', class: "s-maintenance-alert-wrapper" }, index.h("button", { key: 'f0fec5518de00e00302f157b99c38c645b5c1b7b', class: "s-maintenance-alert-close", innerHTML: cancel.Cancel, onClick: () => this.closeAlert() }), index.h("div", { key: 'e1f17c022bf2c7f375c07f39f6d30e55895d8dac', class: "s-maintenance-alert-content" }, index.h("div", { key: '511254633626bb8a2b1ce31941cc738d67a90d78', class: "s-maintenance-alert-container" }, index.h("div", { key: '2d9383e29fdfb9af904e2892801518c6d6f880eb', class: "s-maintenance-alert-icon" }, index.h("img", { key: '4937284ac2ded08930bed981895ad66f08c6c6c3', src: salla.url.cdn('images/alert.png'), alt: "Alert" })), index.h("div", { key: 'faf22e77325fc231bc03f5e78116a53110cd5b76', class: "s-maintenance-alert-text" }, index.h("h2", { key: 'a0bb82c477b0b7f2bfe096a7a1496b05649ece8f' }, this.title), index.h("p", { key: '6120b9c1029eb13b75829d4e87398b245f7e6f8c' }, this.message))), index.h("div", { key: '33513f0620a097f742dbb0c42a0612e7d25e9ac1' }, index.h("a", { key: 'de397335279f2ac6127e591599d9562029bfb462', class: "s-maintenance-alert-btn", href: salla.config.get('maintenance_details.button_url') }, this.buttonTitle)))));
    }
    componentDidLoad() {
