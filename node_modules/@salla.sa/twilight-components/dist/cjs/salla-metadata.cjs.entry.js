...
const SallaMetadata = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "s-metadata-wrapper" }, this.specs.map((item) => {
            return (index.h("div", { class: "s-metadata-box" }, index.h("div", { class: "s-metadata-box-header" }, index.h("i", { class: "sicon-list" }), item.name), item.fields.map((field) => {
                return (index.h("div", { class: "s-metadata-row" }, index.h("p", { class: "s-metadata-row-name" }, field.name), index.h("p", { class: "s-metadata-row-value", innerHTML: this.getValue(field) })));
            })));
        })));
    }
...
exports.salla_metadata = SallaMetadata;
