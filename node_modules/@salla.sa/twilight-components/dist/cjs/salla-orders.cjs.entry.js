...
const SallaOrder = class {
    ...
    getSingleOrderItem(order) {
        ...
        sallaButton.addEventListener('click', (event) => {
            Helper.Helper.copyToClipboard(event);
            Helper.Helper.toggleElementClassIf(sallaButton, 'copied', 'code-to-copy', () => true);
            setTimeout(() => {
                Helper.Helper.toggleElementClassIf(sallaButton, 'code-to-copy', 'copied', () => true);
            }, 1000);
        });
        ...
        div6.textContent = Helper.Helper.formatDateFromString(order.created_at.date, salla.helpers.number, this.languageCode);
    ...
    render() {
        if (this.showPlaceholder) {
            return index.h("div", { class: "s-orders-no-content" }, index.h("i", { class: "sicon-packed-box icon" }), index.h("p", null, this.noOrderText));
        }
        return index.h("div", { class: "s-orders-wrapper" }, index.h("table", { class: "s-orders-table" }, index.h("thead", { class: "s-orders-table-head" }, index.h("tr", { class: "s-orders-table-head-tr" }, index.h("th", { class: "s-orders-table-head-tr-th", scope: "col" }, this.orderNumberText), index.h("th", { class: "s-orders-table-head-tr-th", scope: "col" }, this.totalOrderText), index.h("th", { class: "s-orders-table-head-tr-th", scope: "col" }, this.orderDateText), index.h("th", { class: "s-orders-table-head-tr-th", scope: "col" }, this.orderStatusText))), index.h("tbody", { class: "s-orders-table-tbody", ref: (el) => (this.wrapper = el) })), this.nextPage && (index.h("div", { class: "s-infinite-scroll-wrapper", ref: status => this.status = status }, index.h("button", { onClick: () => this.loadMore(), class: "s-infinite-scroll-btn s-button-btn s-button-primary" }, index.h("span", { class: "s-button-text s-infinite-scroll-btn-text" }, this.loadMoreText ?? this.load_more_text_trans), index.h("span", { class: "s-button-loader s-button-loader-center s-infinite-scroll-btn-loader", ref: btnLoader => this.btnLoader = btnLoader, style: { "display": "none" } })))));
    }
    componentWillLoad() {
...
SallaOrder.style = sallaOrdersCss;

exports.salla_orders = SallaOrder;
