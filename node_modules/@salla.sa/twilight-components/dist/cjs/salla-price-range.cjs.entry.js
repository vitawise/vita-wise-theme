...
const SallaPriceRange = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'e925357a9ad305bcdcb45e08b47328fe0551e966' }, this.filterValues.map((filterValue, index$1) => {
        ...
        }), index.h("div", { key: '402f820f0b39da9351495ef274b50508bc20df94', class: "flex justify-center items-center" }, index.h("div", { key: '9207efd9b9629b9167a0fe373ddb035c7ae319f9', class: "relative max-w-xl w-full" }, index.h("div", { key: 'aeac9d75de4cf783d03a53fd4c87d32e4dd7175d', class: "s-price-range-inputs" }, index.h("div", { key: 'b339efed61f4bcfe4553b0a7256cc8bf87b2a52f', class: "s-price-range-relative" }, index.h("div", { key: '68bee590d6b8a2201cde80044f91bcfcb738ead6', class: "s-price-range-currency" }, " ", salla.config.currency().symbol), index.h("input", { key: '3f74c22f11c4b4e770e8ed729c845cee0496cb12', type: "number", maxlength: "5", ref: el => this.minInput = el, onBlur: (e) => this.handleMinPrice(e), value: this.minPrice, placeholder: this.fromLabel, class: "s-price-range-number-input" })), index.h("div", { key: '3e7dc99a3404a6f8498466a9be3b71db856c23f4', class: "s-price-range-gray-text" }, " -"), index.h("div", { key: 'fa2703140f2346df311bf329c40f67b4a16df247', class: "s-price-range-relative" }, index.h("div", { key: 'e0ac6ee63329b64b320c8fb12c4a94b903785443', class: "s-price-range-currency" }, " ", salla.config.currency().symbol), index.h("input", { key: '5aeab39a70a9ff02654b2c04b4db908672ca2dd8', type: "number", maxlength: "5", ref: el => this.maxInput = el, onBlur: (e) => this.handleMaxPrice(e), value: this.maxPrice, placeholder: this.toLabel, class: "s-price-range-number-input", "aria-describedby": "price-currency" })), index.h("salla-button", { key: '6b27214991ebac764b2220beb4cb31a339203657', color: 'gray', shape: 'icon', size: 'small', fill: 'outline', onClick: (event) => this.changedEventHandler(event) }, index.h("span", { key: '7713e50bc43c1be0610f5f64e7513c0bbe5ec249', innerHTML: this.isRTL ? arrowLeft.arrowLeft : arrowRight })))))));
    }
    componentDidLoad() {
        this.isReady = true;
    }
