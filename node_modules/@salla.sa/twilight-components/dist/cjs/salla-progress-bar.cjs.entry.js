...
const SallaProgressBar = class {
    ...
    getProgressBar() {
        return this.target ? [
            !this.hideUnits ? (index.h("div", { class: "s-progress-bar-target-section" }, index.h("span", { innerHTML: `${salla.helpers.number(this.value)} ${this.unit}` }), index.h("span", { innerHTML: `${salla.helpers.number(this.target)} ${this.unit}` }))) : null,
            index.h("div", { class: "s-progress-bar-wrapper", style: { height: this.height } }, index.h("div", { class: {
