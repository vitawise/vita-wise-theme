...
const SallaSlider = class {
    constructor(hostRef) {
        ...
        this.afterInit = index.createEvent(this, "afterInit");
        this.slideChange = index.createEvent(this, "slideChange");
        this.reachBeginning = index.createEvent(this, "reachBeginning");
        this.reachEnd = index.createEvent(this, "reachEnd");
        this.slideChangeTransitionEnd = index.createEvent(this, "slideChangeTransitionEnd");
        this.slideChangeTransitionStart = index.createEvent(this, "slideChangeTransitionStart");
        this.slideNextTransitionEnd = index.createEvent(this, "slideNextTransitionEnd");
        this.slideNextTransitionStart = index.createEvent(this, "slideNextTransitionStart");
        this.slidePrevTransitionEnd = index.createEvent(this, "slidePrevTransitionEnd");
        this.slidePrevTransitionStart = index.createEvent(this, "slidePrevTransitionStart");
        this.sliderMove = index.createEvent(this, "sliderMove");
        this.touchSliderEnd = index.createEvent(this, "touchSliderEnd");
        this.touchSliderMove = index.createEvent(this, "touchSliderMove");
        this.touchSliderStart = index.createEvent(this, "touchSliderStart");
        this.sliderTransitionEnd = index.createEvent(this, "sliderTransitionEnd");
        this.sliderTransitionStart = index.createEvent(this, "sliderTransitionStart");
        /**
    ...
    render() {
        ...
        return (index.h(index.Host, { class: 's-slider-wrapper ' + classes }, this.blockTitle || this.showControls ?
            index.h("div", { class: "s-slider-block__title" }, this.blockTitle ?
                ...
                : '', this.showControls ?
                index.h("div", { class: "s-slider-block__title-nav", dir: "rtl" }, index.h("button", { "aria-label": "Previous Slide", class: "s-slider-prev s-slider-nav-arrow" }, index.h("span", { class: "s-slider-button-icon", innerHTML: this.direction == 'rtl' ? keyboard_arrow_right.ArrowRightIcon : keyboard_arrow_right.ArrowLeftIcon })), index.h("button", { "aria-label": "Next Slide", class: "s-slider-next s-slider-nav-arrow" }, index.h("span", { class: "s-slider-button-icon", innerHTML: this.direction == 'rtl' ? keyboard_arrow_right.ArrowLeftIcon : keyboard_arrow_right.ArrowRightIcon })))
                : ''))
            ...
            index.h("div", { class: "s-slider-thumbs-nav", dir: "rtl" }, index.h("button", { "aria-label": "Previous Slide", class: "s-slider-thumbs-prev s-slider-nav-arrow" }, index.h("span", { class: "s-slider-button-icon", innerHTML: this.direction == 'rtl' ? keyboard_arrow_right.ArrowRightIcon : keyboard_arrow_right.ArrowLeftIcon })), index.h("button", { "aria-label": "Next Slide", class: "s-slider-thumbs-next s-slider-nav-arrow" }, index.h("span", { class: "s-slider-button-icon", innerHTML: this.direction == 'rtl' ? keyboard_arrow_right.ArrowLeftIcon : keyboard_arrow_right.ArrowRightIcon })))
            : null))
            : null));
    }
...
exports.salla_slider = SallaSlider;
