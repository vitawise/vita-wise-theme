...
var facebook = require('./facebook-DbXua6B9.js');
...
const SallaSocialShare = class {
    constructor(hostRef) {
        ...
        this.platformIcons = [{ icon: whatsapp, name: Socials.WHATSAPP }, {
            ...
            }, { icon: facebook.twitter, name: Socials.TWITTER }, { icon: mail.MailIcon, name: Socials.EMAIL }, {
                icon: copy_link,
     ...
     */
    async open() {
        const animateList = new anime_es.anime.timeline().add({
        ...
        animateList.add({
            ...
            opacity: [0, 1],
            duration: 1400,
            delay: anime_es.anime.stagger(100)
        }, '-=200');
    ...
    render() {
        return (index.h("div", { key: 'ce2897e4cac7940407f6466a0eb4b2ff9fab3236', class: "s-social-share-wrapper" }, index.h("slot", { key: 'a0d4beebb29febd203d619845223c4e62b6b9c21', name: 'widget' }, index.h("salla-button", { key: '8615149ec0475bafc2f94d4b0bacfd49048d112f', "aria-label": "Share", onClick: () => this.open(), class: "s-social-share-btn", shape: "icon", fill: "outline", color: "light" }, index.h("span", { key: '187e9aa3194eedafd1355fc3e79db1118e21050f', innerHTML: this.opened ? cancel.Cancel : ShareAlt }))), index.h("ul", { key: '7a1192bbf8e39d7fa101deae229949cc730aff0b', ref: el => this.shareMenu = el, class: "s-social-share-list a2a_kit share", "data-a2a-url": this.url ? this.url : window.location.href, "data-a2a-title": this.urlName ? this.urlName : document.title }, this.platforms.split(',').map(platform => {
