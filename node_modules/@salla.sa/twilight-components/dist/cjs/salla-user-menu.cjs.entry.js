...
const SallaUserMenu = class {
    constructor(hostRef) {
        ...
        this.OrderUpdate = 0;
        this.items = {
            notifications: bellRing.BellRing,
            orders: OrderIcon,
            pending_orders: cart.PendingOrdersIcon,
            wishlist: star.WishListIcon,
            wallet: WalletIcon,
            loyalty_program: gift.loyaltyProgramIcon,
            profile: UserCircle
        };
    }
    ...
    replaceParams(body) {
        return body
            ...
            .replace(/\{icon\}/g, keyboard_arrow_down.ArrowDown);
    }
    getTheHeader() {
...
exports.salla_user_menu = SallaUserMenu;
