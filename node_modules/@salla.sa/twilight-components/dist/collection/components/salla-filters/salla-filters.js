...
export class SallaFilters {
    ...
    render() {
        return h(Host, { key: '3b38160573591da8249606b8c12b72b58d03551d' }, this.filters?.map(option => h("salla-filters-widget", { option: option, filtersData: this.filtersData, onChanged: ({ detail: { event, option, value } }) => {
