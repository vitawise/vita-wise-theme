...
import { c as require_root, b as requireIsObject, r as requireIsSymbol } from './isObject.js';
import { d as defineCustomElement$3 } from './salla-button2.js';
import { d as defineCustomElement$2 } from './salla-review-card2.js';
...
const SallaReviewsPage$1 = /*@__PURE__*/ proxyCustomElement(class SallaReviewsPage extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.reviews = [];
    ...
    get el() { return this; }
    static get style() { return sallaReviewsPageCss; }
}, [0, "salla-reviews-page", {
        "reviews": [32],
        "isLoading": [32],
        "pagination": [32],
        "sort": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["salla-reviews-page", "salla-button", "salla-review-card"];
    components.forEach(tagName => { switch (tagName) {
        case "salla-reviews-page":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SallaReviewsPage$1);
            }
            break;
        case "salla-button":
            if (!customElements.get(tagName)) {
...
const SallaReviewsPage = SallaReviewsPage$1;
const defineCustomElement = defineCustomElement$1;

export { SallaReviewsPage, defineCustomElement };
