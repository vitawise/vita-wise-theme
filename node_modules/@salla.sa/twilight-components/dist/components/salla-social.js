...
const SallaSocial$1 = /*@__PURE__*/ proxyCustomElement(class SallaSocial extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    static get style() { return sallaSocialCss; }
}, [0, "salla-social", {
        "links": [32],
        "iconsList": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["salla-social"];
    components.forEach(tagName => { switch (tagName) {
        case "salla-social":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, SallaSocial$1);
            }
            break;
    } });
}
...
const SallaSocial = SallaSocial$1;
const defineCustomElement = defineCustomElement$1;

export { SallaSocial, defineCustomElement };
