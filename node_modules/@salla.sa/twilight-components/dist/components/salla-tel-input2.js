...
const SallaTelInput = /*@__PURE__*/ proxyCustomElement(class SallaTelInput extends HTMLElement {
    /**
    ...
    async loadTelInput() {
        if (this.TelInput)
            return;
        try {
            const telInputModule = await import('./index2.js').then(function (n) { return n.i; });
