 ...
 */
import { r as registerInstance, h, H as Host, c as createEvent, a as getElement } from './index-BpoZBzEy.js';
...
const SallaMap = class {
    ...
    // render
    render() {
        return (h(Host, { key: '7d4c5c9abf034d5568ab037dcb58e7fbeb98212c', class: "s-map-wrapper" }, h("salla-modal", { key: '58b5cc9ec4377a9206485a435c198c30390982c4', class: "s-map-modal-wrapper", noPadding: true, ref: modal => {
                this.locationModal = modal;
            } }, this.getLocationModal()), h("slot", { key: 'c32c39e9361dcbe8c0bc4830614aa98e00a76663', name: "button" }, h("salla-button", { key: '0dda0709bb35f23d99394215aaf8c8b5344c641e', onClick: () => {
                this.open();
            }, color: "primary", class: "s-map-location-button" }, h("span", { key: '367337f317474cf49665a14b5aca50f3daf6c6f8', class: "s-map-location-icon", innerHTML: this.formattedAddress ? Edit : Location }), this.formattedAddress ? (h("div", null, this.locateButtonEdit, " | ", this.formatAddress(this.formattedAddress))) : (this.locateButtonTitle))), h("input", { key: 'f3a1561cd74f089de4a09d2d9a72b73f1ebcfc13', class: "s-hidden", name: this.name, required: this.required, value: this.getLatLng(), ref: color => this.mapInput = color })));
    }
    get host() { return getElement(this); }
};
SallaMap.style = sallaMapCss;

export { SallaAccordionBody as salla_accordion_body, SallaAccordionHead as salla_accordion_head, SallaMap as salla_map };
