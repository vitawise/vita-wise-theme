 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host, a as getElement, e as axios } from './index-BpoZBzEy.js';
...
const SallaProductAvailability = class {
    ...
    render() {
        return (h(Host, { key: '19821212be7330f1c6fee4851366fa02f56681e0', class: "s-product-availability-wrap" }, this.isSubscribed || this.isVisitorSubscribed
...
const SallaQuickBuy = class {
    ...
    render() {
        return h(Host, { key: 'adde5bca5d706adcc9d9774bb861f0c12bf52961' }, this.quickBuyButton());
    }
    quickBuyButton() {
