 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host, a as getElement } from './index-BpoZBzEy.js';
...
const SallaColorPicker = class {
    ...
    initColorPicker() {
        this.pickerReady = import('./vanilla-picker-COFfA4w_.js').then(function (n) { return n.v; }).then(mod => {
    ...
    render() {
        return (h(Host, { key: '1da3853e7ba946b680f99ec07040035086cdf383', class: "s-color-picker-main" }, h("slot", { key: '16812a7f96d476deab7b0fe4b59f29595cc9f302', name: "widget" }, h("div", { key: 'a2820835ad0ed81022871d76fada51885f2cd144', class: "s-color-picker-widget" }, h("div", { key: 'e65430e20d893fc372449c933a619cceec98b7db', class: "s-color-picker-widget-canvas", ref: dv => (this.canvas = dv) }), h("span", { key: 'f5cfd889738260dcdb1de6da426c673b4685cffe', innerHTML: ArrowDown }))), h("input", { key: '073754e72beaae864bce94a4de29eee7d0c189ba', class: "s-hidden", name: this.name, required: this.required, value: this.color, ref: color => (this.colorInput = color) })));
    }
    componentDidLoad() {
        if (this.canvas)
    ...
    async loadFilePond() {
        ...
        try {
            const [FilePondModule, FilePondPluginFileValidateSize, FilePondPluginImageExifOrientation, FilePondPluginImagePreview, FilePondPluginImageEdit, FilePondPluginFileValidateType, FilePondPluginFilePoster] = await Promise.all([
                import('./filepond-Dw5LLI9G.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-file-validate-size-Mq0exUD8.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-image-exif-orientation-D1rHHcpP.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-image-preview-CSOxFeXE.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-image-edit-B_Mw4seW.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-file-validate-type-BjZfWuzA.js').then(function (n) { return n.f; }),
                import('./filepond-plugin-file-poster-BQve1M8B.js').then(function (n) { return n.f; })
            ]);
...
const SallaQuantityInput = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'e7d9d747cb9498c384b7723067c81147dba9731c', class: "s-quantity-input" }, h("div", { key: '7b9b7849e00a68091647a8de34243481ddb5c2ed', class: "s-quantity-input-container" }, h("button", { key: '72032114d6b4294faf654c19909c8ddc6b46b6b6', onClick: () => this.increase(), class: "s-quantity-input-increase-button s-quantity-input-button", type: "button", "aria-label": salla.lang.getWithDefault('common.elements.increase_quantity', 'Increase quantity') }, !this.hasIncrementSlot ? h("span", { innerHTML: plusIcon }) : '', h("slot", { key: 'c229ef5206240d5ee27371498bf8fabf6a6c1050', name: "increment-button" })), h("input", { key: 'bb9c2ac443c6920085261e19c6c32ac705360020', class: "s-quantity-input-input", ...inputAttributes, ref: (el) => this.textInput = el, onInput: (event) => this.setValue(event.target.value), min: "1", readOnly: this.disableInput, value: this.quantity }), h("button", { key: '1f3dfd851cc88f97c8f80a3bcd741e950061312e', class: "s-quantity-input-decrease-button s-quantity-input-button", onClick: () => this.decrease(), type: "button", "aria-label": salla.lang.getWithDefault('common.elements.decrease_quantity', 'Decrease quantity') }, !this.hasDecrementSlot ? h("span", { innerHTML: minusIcon }) : '', h("slot", { key: '1058e6b14c8918f960a74ee18e7ac5d77bc5e3bc', name: "decrement-button" })))));
    }
    get host() { return getElement(this); }
...
const SallaTelInput = class {
    ...
    async loadTelInput() {
        if (this.TelInput)
            return;
        try {
            const telInputModule = await import('./index-COcTESat.js').then(function (n) { return n.i; });
