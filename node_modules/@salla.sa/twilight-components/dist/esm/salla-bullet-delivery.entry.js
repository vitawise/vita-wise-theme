 ...
 */
import { r as registerInstance, c as createEvent, h, H as Host } from './index-BpoZBzEy.js';
...
const SallaBulletDelivery = class {
    constructor(hostRef) {
        ...
        this.bulletDeliveryConfirmed = createEvent(this, "bulletDeliveryConfirmed");
        this.bulletDeliveryClosed = createEvent(this, "bulletDeliveryClosed");
        this.addressCreated = createEvent(this, "addressCreated");
        this.headerContextUpdate = createEvent(this, "headerContextUpdate");
    ...
    render() {
        return (h(Host, { key: '5d79f6404692b4a68504770a54f46c9e5161e533', class: "s-bullet-delivery" }, h("salla-modal", { key: 'f123012f8593e20eeb14ebf59fc8dc5af9bbe12b', ref: (modal) => {
                this.modal = modal;
...
export { SallaBulletDelivery as salla_bullet_delivery };
