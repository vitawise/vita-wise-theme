 ...
 */
import { r as registerInstance, h, a as getElement } from './index-BpoZBzEy.js';
import { S as SpecialDiscountIcon } from './special-discount-Ctkfc4K-.js';
 ...
 */
    ...
    getOfferContent() {
        if (this.offer.get.discounts_table) {
            ...
            return (h("salla-products-slider", { key: (this.offer.get.products?.map(product => product.id) || []).join(","), source: "selected", "source-value": `[${(this.offer.get.products?.map(product => product.id) || []).join(",")}]`, "slider-config": JSON.stringify(sliderConfig) }));
            //   return <salla-slider
            //     type="carousel"
    ...
    //   }
    render() {
        return h("salla-modal", { key: 'bf6b6ebffa1fff9faf744913029ae4eb6f5ce499', "has-skeleton": true, "sub-title": this.offer_message, ref: modal => this.modal = modal, isLoading: true, class: `s-offer-modal-type-${this.offer_type ? this.offer_type : ''}` }, h("div", { key: '4198a24f336464f9d17170385e4f2e07c66821de', slot: 'loading' }, h("div", { key: '7d59e8a5f9ee1bd4467d2b463c5901b1f01a11c2', class: "s-offer-modal-skeleton" }, h("div", { key: '8139ef78f0d1f5dfe3ca4e00018f27ec7918944b', class: "s-offer-modal-skeleton-header" }, h("salla-skeleton", { key: '173e58027399d3b3f73dadc2d7a0e7373de62e75', type: 'circle', height: '80px', width: '80px' }), h("salla-skeleton", { key: '77b033d9834f5e9a35f94bd050a5fcb2147419a1', height: '15px', width: '50%' }), h("salla-skeleton", { key: 'cdce462a5437dfc804582b115a1464ebfc6026dc', height: '10px', width: '30%' })), h("div", { key: 'd9add56d0af01e12636f3bbf048a9b143c2874d0', class: "s-offer-modal-skeleton-items" }, [...Array(3)].map(() => h("div", { class: "s-offer-modal-skeleton-item" }, h("salla-skeleton", { height: '9rem' }), h("div", { class: "s-offer-modal-skeleton-item-title" }, h("salla-skeleton", { height: '15px', width: '100%' })), h("div", { class: "s-offer-modal-skeleton-item-subtitle" }, h("salla-skeleton", { height: '9px', width: '50%' }), h("div", { innerHTML: Cart2 }))))), h("div", { key: 'd146a40cd8eedf5243fc40f713f19247fa7c7bbc', class: "s-offer-modal-skeleton-footer" }, h("salla-skeleton", { key: 'bcfd8d24a7a920f1a47751b1520f717fcbc954c4', height: '15px', width: '50%' }), h("salla-skeleton", { key: '04abbbe40c1c0fcafe3d3a287d556ea9258cfbd4', height: '15px', width: '30%' })))), !this.hasError && this.offer !== null
