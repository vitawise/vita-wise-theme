...
export declare class SallaColorPicker {
    ...
    private pickerReady;
    private colorInput;
    /** Cached viewport width – updated on load/resize. Avoids reading innerWidth at popup open (forced reflow). */
    ...
    submittedHandler(color: Color): Promise<void>;
    /**
     ...
     */
    private getViewportWidthFromBreakpoints;
