import type { SallaSliderProps } from '../salla-slider/salla-slider';
export declare class SallaProductsSlider {
    ...
    */
    ...
    sliderConfig: any;
    /**
     * Additional props to pass through to the inner salla-slider component.
     * Use this to set any salla-slider props (e.g. loop, pagination, showControls, enableSingleSlideMode).
     * @example
     * productsSlider.sliderProps = { loop: true, pagination: true };
     */
